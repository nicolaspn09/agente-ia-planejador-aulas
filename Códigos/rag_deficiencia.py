...
caminho_arquivos = r"Docs\Planejamento - Deficiencia"
...
print("Iniciando o processo de carreCOMPANY_NAME e armazenamento dos arquivos...")
...
COLLECTION_NAME = "diretrizes_aee" # Um nome descritivo para sua tabela de vetores
